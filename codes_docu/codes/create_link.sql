...
as	(
		...
		WHERE age(tb1.f_tm,tb.t_tm) < interval '30 minutes' --中转时间＜30分钟
...
as	(
		...
		inner join cleaned_20190301 as tb1 
...
drop table if exists link_20190301;
create table link_20190301 
as	(
		SELECT	*
		FROM	link_true1
		UNION ALL	
